...
class CMT(object):
	...
	def initialise(self, im_gray0, tl, br):
		...
		#self.detector = cv2.xfeatures2d.FeatureDetector_create(self.DETECTOR)
		#self.descriptor = cv2.xfeatures2d.DescriptorExtractor_create(self.DESCRIPTOR)
		#self.matcher = cv2.xfeatures2d.DescriptorMatcher_create(self.MATCHER)
		self.detector = cv2.BRISK_create()
		self.descriptor = self.detector#cv2.xfeatures2d.BriefDescriptorExtractor_create()
